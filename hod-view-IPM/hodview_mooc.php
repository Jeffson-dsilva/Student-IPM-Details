...
// Fetch MOOC courses from the database
$sql = "SELECT name, usn FROM mooc_courses";
...
<head>
    ...
    <link rel="stylesheet" href="hodview_mooc.css">
</head>
<body>
    <header>
        <div class="logo">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <form action='hodmooc_details.php' method='GET'>
