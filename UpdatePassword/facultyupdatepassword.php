...
// Fetch user data (name and employee_id) from the faculty table based on email
...
<head>
    ...
    <title>Faculty Update Password</title>
...
<div class="navbar">
    ...
    <div class="dropdown-menu" id="dropdown-menu">
        <a href="ftDashboard.php"><i class="fas fa-home"></i>Home</a>
    </div>
